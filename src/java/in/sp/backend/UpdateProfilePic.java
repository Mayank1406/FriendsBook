...
public class UpdateProfilePic extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
      ...
      try
      {
          ...
          boolean status = DbQueries.updateProfilePic(user_id, attachment_name);
          if(status)
          {
              session.setAttribute("session_profile_pic", attachment_name);
              System.out.println(session.getAttribute("session_profile_pic"));
              ...
              RequestDispatcher rd2 = request.getRequestDispatcher("editProfile.jsp");
